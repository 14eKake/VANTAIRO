...
document.getElementById("saveJSON").addEventListener("click", () => {
  ...
  inputs.forEach((input) => {
    if (input.name || input.id) {
      // Vérifie que l'input a un name ou un id
...
document
  .getElementById("addMartialRowBtn")
  .addEventListener("click", function () {
    const table = document
      .getElementById("martialTechniquesTable")
      .getElementsByTagName("tbody")[0];
    const rowCount = table.rows.length + 1;
...
document
  .getElementById("addSpellRowBtn")
  .addEventListener("click", function () {
    const table = document
      .getElementById("manaSpellsTable")
      .getElementsByTagName("tbody")[0];
    const rowCount = table.rows.length + 1;
...
document
  .getElementById("addTalentRowBtn")
  .addEventListener("click", function () {
    const table = document
      .getElementById("talentgenerique")
      .getElementsByTagName("tbody")[0];
    const rowCount = table.rows.length + 1;
